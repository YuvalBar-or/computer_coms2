...
def server(host: str, port: int) -> None:
    ...
    with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as server_socket:
        ...
        # * Fill in start (1)
        server_socket.bind((host,port)) # binds the socket to the host and the port.
        server_socket.listen() # listens for incoming. 
        # * Fill in end (1)
        ...
        while True:
            try:
                ...
                client_socket, address = server_socket.accept() #accepts the connections. 
...
def client_handler(client_socket: socket.socket, client_address: tuple[str, int]) -> None:
    ...
    with client_socket:  # closes the socket when the block is exited
        ...
        while True:
            ...
            data = client_socket.recv(8192) #recievces data from the client. 
            ...
            try:
                ...
                # * Fill in start (4)
                client_socket.sendall(response) #sends the response.
                # * Fill in end (4)
